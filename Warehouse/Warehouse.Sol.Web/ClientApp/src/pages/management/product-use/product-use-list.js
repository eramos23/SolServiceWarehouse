...
const ProductoUseList = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text,data, key) =>
                <>
                    <Link to={`/Management/ProductUse/Edit/${data.id}`}><Button size="small" icon={<EditTwoTone />} /> {"  "}</Link>
                    <Popconfirm
    ...
    const handleSeach = (value) => {
        ...
        axios.get(SMART.base, { params: value })
            .then(res => {
                setSearching(false)
                setProductUses(res.data.data.map((item, i) => {
                    return {
                        key: i,
                        ...item
                    }
    ...
    return (
        <div>
            <Breadcrumb className="breadcrumb-margin">
                ...
                <Breadcrumb.Item>Uso de Producto</Breadcrumb.Item>
                <Breadcrumb.Item>Listar</Breadcrumb.Item>
            </Breadcrumb>
            <Title level={3}>Listado Usos de Productos</Title>
            ...
            <Card size="small">
                ...
                >
                    <Row gutter={[10, 0]}>
                        ...
                        <Col sx={24} lg={3} className="width100">
                            <Form.Item>
                                <Link to='/Management/ProductUse/Create'>
...
export default ProductoUseList